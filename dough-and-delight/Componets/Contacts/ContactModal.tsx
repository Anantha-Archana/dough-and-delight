...
export const ContactModal = () => {
  return (
    <section className="relative min-h-screen w-full overflow-hidden">
      ...
      <div
        className="relative z-10 flex items-center justify-center px-4 py-20 font-['Comic_Sans_MS',cursive]"
        data-aos="fade-in"
      >
        <div
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            >
              ...
              <div>
                ...
                <p className="text-[#7a4a3b] mt-2">doughanddelight@gmail.com</p>
              </div>
            </div>
